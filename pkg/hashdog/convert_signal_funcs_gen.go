...
// ToOBDDTCList0 converts data from field 'obdDTCList' of type string to 'Vehicle.OBD.DTCList' of type string.
...
// ToOBDStatusDTCCount0 converts data from field 'obdStatusDTCCount' of type float64 to 'Vehicle.OBD.Status.DTCCount' of type float64.
// Vehicle.OBD.Status.DTCCount: Number of Diagnostic Trouble Codes (DTC)
func ToOBDStatusDTCCount0(originalDoc []byte, val float64) (float64, error) {
	return val, nil
}
