...
func TestFullFromDataConversion(t *testing.T) {
	...
	expectedSignals := []vss.Signal{
		...
		{CloudEventHeader: baseHeader, Data: vss.SignalData{Timestamp: ts, Name: vss.FieldOBDOilTemperature, ValueNumber: 86}},
		...
		{CloudEventHeader: baseHeader, Data: vss.SignalData{Timestamp: ts, Name: vss.FieldOBDEngineLoad, ValueNumber: 15.686274509803921}},
		...
		{CloudEventHeader: baseHeader, Data: vss.SignalData{Timestamp: ts, Name: vss.FieldOBDLongTermFuelTrim1, ValueNumber: -11.71875}},
		{CloudEventHeader: baseHeader, Data: vss.SignalData{Timestamp: ts, Name: vss.FieldOBDLongTermFuelTrim2, ValueNumber: -10.15625}},
		{CloudEventHeader: baseHeader, Data: vss.SignalData{Timestamp: ts, Name: vss.FieldOBDMAP, ValueNumber: 19.0}},
		{CloudEventHeader: baseHeader, Data: vss.SignalData{Timestamp: ts, Name: vss.FieldOBDIntakeTemp, ValueNumber: 37.0}},
		{CloudEventHeader: baseHeader, Data: vss.SignalData{Timestamp: ts, Name: vss.FieldOBDMaxMAF, ValueNumber: 4.5200000000000005}},
		{CloudEventHeader: baseHeader, Data: vss.SignalData{Timestamp: ts, Name: vss.FieldOBDThrottlePosition, ValueNumber: 88.62745098039215}},
		{CloudEventHeader: baseHeader, Data: vss.SignalData{Timestamp: ts, Name: vss.FieldOBDFuelRailPressure, ValueNumber: 4457.891}},
		{CloudEventHeader: baseHeader, Data: vss.SignalData{Timestamp: ts, Name: vss.FieldOBDBarometricPressure, ValueNumber: 94.0}},
		{CloudEventHeader: baseHeader, Data: vss.SignalData{Timestamp: ts, Name: vss.FieldOBDEthanolPercent, ValueNumber: 35.68627450980392}},
		{CloudEventHeader: baseHeader, Data: vss.SignalData{Timestamp: ts, Name: vss.FieldPowertrainTransmissionActualGear, ValueNumber: 10}},
		{CloudEventHeader: baseHeader, Data: vss.SignalData{Timestamp: ts, Name: vss.FieldPowertrainTransmissionActualGearRatio, ValueNumber: 2.00}},
	}
