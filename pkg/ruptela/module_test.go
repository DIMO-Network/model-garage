...
func TestCloudEventConvert(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			expectError:      false,
			length:           3,
			expectedSubject:  vehicleSubject1,
			expectedProducer: aftermarketSubject2,
		},
		{
		...
		},
		{
			...
			expectError:      false,
			length:           1,
			expectedSubject:  aftermarketSubject2,
			expectedProducer: aftermarketSubject2,
		},
		{
	...
	}{
		{
			...
			cloudEvent: cloudevent.CloudEvent[json.RawMessage]{
				CloudEventHeader: cloudevent.CloudEventHeader{
					...
					Source:      "ruptela/TODO",
					Subject:     aftermarketSubject33,
					Time:        ts,
				},
				Data: json.RawMessage(signalData),
			},
			expectedSignals: []vss.Signal{
				{Subject: aftermarketSubject33, Timestamp: ts, Name: vss.FieldExteriorAirTemperature, ValueNumber: -32, Source: "ruptela/TODO"},
				{Subject: aftermarketSubject33, Timestamp: ts, Name: vss.FieldPowertrainCombustionEngineECT, ValueNumber: -32, Source: "ruptela/TODO"},
			},
			expectedError: nil,
		},
		{
			...
			expectedSignals: []vss.Signal{
				{Subject: aftermarketSubject33, Timestamp: ts, Name: vss.FieldCurrentLocationAltitude, ValueNumber: 123.2, Source: "ruptela/TODO"},
				{Subject: aftermarketSubject33, Timestamp: ts.Add(time.Second), Name: vss.FieldCurrentLocationAltitude, ValueNumber: 1.2, Source: "ruptela/TODO"},
			},
			expectedError: nil,
		},
		{
			...
			expectedSignals: []vss.Signal{
				{Subject: aftermarketSubject33, Timestamp: ts, Name: "obdDTCList", ValueString: "[\"P0101\",\"P0202\"]", Source: "ruptela/TODO"},
			},
			expectedError: nil,
		},
		{
